...
@RestController
public class EmployeeIdCreation {
    @Autowired
  ...
  private ProjectService projectService;
    ...
    public ResponseEntity< List<ProjectBillingStatusDTO>> getProjectData(@RequestBody ProjectBillingStatusDTO projectBillingStatusDTO){
    ...
    public ResponseEntity<List<ProjectEntity.CompanyMobileEntity>> companyMobileController() {
